...
export const pageSitemapMeta: Record<PageId, PageSitemapMeta> = {
	home: { priority: 0.95, changefreq: 'daily', i18nPriority: 0.88, lastmod: '2026-08-17' },
	/** Money URL for "tarkov cheats" */
	hacks: { priority: 1.0, changefreq: 'weekly', i18nPriority: 0.9, lastmod: '2026-08-17' },
	...
	'mod-menu': { priority: 0.3, changefreq: 'yearly', i18nPriority: 0.2, lastmod: '2026-08-17' },
	'soft-aim': { priority: 0.3, changefreq: 'yearly', i18nPriority: 0.2, lastmod: '2026-08-17' },
	'best-cheats': { priority: 0.3, changefreq: 'yearly', i18nPriority: 0.2, lastmod: '2026-08-17' },
	'aimbot-hack': { priority: 0.3, changefreq: 'yearly', i18nPriority: 0.2, lastmod: '2026-08-17' },
	...
	radar: { priority: 0.9, changefreq: 'weekly', i18nPriority: 0.85, lastmod: '2026-08-17' },
	'battleye': { priority: 0.3, changefreq: 'yearly', i18nPriority: 0.2, lastmod: '2026-08-17' },
	'tarkov-esp': { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-17' },
	'tarkov-aimbot': { priority: 0.92, changefreq: 'weekly', i18nPriority: 0.86, lastmod: '2026-08-17' },
	pricing: { priority: 0.94, changefreq: 'weekly', i18nPriority: 0.85, lastmod: '2026-08-17' },
	features: { priority: 0.9, changefreq: 'weekly', i18nPriority: 0.84, lastmod: '2026-08-17' },
	setup: { priority: 0.88, changefreq: 'weekly', i18nPriority: 0.84, lastmod: '2026-08-17' },
	updates: { priority: 0.93, changefreq: 'daily', i18nPriority: 0.85, lastmod: '2026-08-17' },
	faq: { priority: 0.8, changefreq: 'monthly', i18nPriority: 0.82, lastmod: '2026-08-17' },
	support: { priority: 0.8, changefreq: 'monthly', i18nPriority: 0.82, lastmod: '2026-08-17' },
