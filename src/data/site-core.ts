...
export const productInfo = {
	...
	features: {
		esp: [
			...
			'Box, skeleton, chams, health, and distance',
			'Loot ESP with filters, price, and containers',
		...
		aimbot: [
			...
			'Smart bone, lock, and max distance',
			'No recoil, no sway, and instant ADS',
			'Hotkeys and config save / load',
		],
		radar: ['Streamproof overlay', 'Cloud DMA for full functionality', 'Config system'],
		general: [
			fillBrandTokens('{antiCheat} maintenance after patches'),
			'Raids only — separate key from Arena',
